...
function FruitNinja() {
  ...
  const slicedTextures = useTexture([
    ...
    '/shapes/sliced/csharp_sliced.png',
    '/shapes/sliced/python_sliced.png',
    '/shapes/sliced/git_sliced.png',
    '/shapes/sliced/flutter_sliced.png',
    '/shapes/sliced/nodejs_sliced.png',
  ]);
