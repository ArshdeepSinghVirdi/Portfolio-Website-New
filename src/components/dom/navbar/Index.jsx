  ...
  return (
    <>
      ...
      <header className={styles.root} role="banner">
        <Glass className={styles.glassBar} style={{ display: 'block' }} optics={{ frost: 4, saturate: 1.18 }}>
          <div className={styles.innerHeader}>
            <Link onClick={goToTop} aria-label="Go home" scroll={false} href="/">
              <h4 className={clsx('bold', 'h4', styles.wordmark)}>ARSHDEEP SINGH</h4>
            </Link>

            <div className={styles.rightContainer}>
              {!isMobile && <ButtonLink href="mailto:arshdeepsingh92283@gmail.com" label="GET IN TOUCH" />}
              <MenuButton />
            </div>
          </div>
        </Glass>
