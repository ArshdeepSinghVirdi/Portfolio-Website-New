...
const seo = {
  title: 'Arshdeep Singh Virdi - Projects',
  description: 'Selected projects in AI/ML, Full-stack Web Development, and Enterprise software systems.',
  keywords: ['Arshdeep Singh Virdi', 'Work', 'Projects', 'Portfolio', 'AI Engineer'],
};
  ...
  return (
    <>
      ...
      <section className={clsx(styles.titleContainer, 'layout-block-inner')}>
        <h1 className={clsx(styles.title, 'h1')}>All Work</h1>
      </section>
