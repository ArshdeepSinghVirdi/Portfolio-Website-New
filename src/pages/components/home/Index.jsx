    ...
    <section ref={rootRef} className={clsx(styles.root)}>
      <div className={clsx(styles.topContainer, 'layout-grid-inner')}>
        <div className={styles.leftContainer}>
          <h2 className="h2">Engineering Intelligent Systems</h2>
          <h2 className={clsx('h2', 'bold')}>With Code & AI.</h2>
        </div>
        {!isMobile && (
          <h6 className={clsx('h6', styles.rightContainer)}>
            I&apos;m Arshdeep Singh Virdi, a Software Engineer specializing in AI/ML integration and full-stack systems. Recently completed my SDE Apprenticeship journey at Boeing building scalable
            enterprise features and applications, and will be joining full-time this September.
          </h6>
        )}
      </div>
